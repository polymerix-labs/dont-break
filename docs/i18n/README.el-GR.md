...
## Γλώσσες και δυνατότητες

Ποιες γλώσσες χαρτογραφεί το dont-break, και τι μπορεί πραγματικά η καθεμία, είναι στο **[dont-break.com/language-support](https://dont-break.com/language-support)**.
