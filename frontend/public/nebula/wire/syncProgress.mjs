...
import { isSyncInProgress } from "./graphSessionPolicy.mjs";
import { SyncPhase, SyncProgressLabel, SyncProgressThresholds, phaseLabel, syncPhaseStatusLabel, } from "./sync.mjs";
export function progressFromSnapshot(session) {
    if (!session) {
...
export function syncStatusLabel(session) {
