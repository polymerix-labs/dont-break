...
export const HostMessageType = Object.freeze({
...
export const ViewerMessageType = Object.freeze({
    VIEWER_READY: "viewer-ready",
    TOOLBAR_SYNC: "toolbar-sync",
    SEARCH_RESULTS: "search-results",
    NODE_SELECTED: "node-selected",
});
export const ViewerEmbedParams = Object.freeze({
    EMBED: "embed",
    STANDALONE: "standalone",
    VERSION: "v",
});
export const ViewerEmbedValues = Object.freeze({
    ENABLED: "1",
});
